...
public class MersenneTwisterRandom {
	...
	private ServletContext context;  // 添加ServletContext对象
	...
	// 添加构造函数，允许传递ServletContext对象
	public MersenneTwisterRandom(ServletContext context) {
